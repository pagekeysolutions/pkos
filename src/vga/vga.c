...
void vga_exit() {
	...
	// struct VGA vga;
	// get_vga(vga);
	// set_vga(text_mode_vga);

	// Go back to text mode
	// struct AttributeController ac;
	// get_ac(ac);
	// ac.regPalettes[0] = 0;
	// ac.regPalettes[1] = 0x61;
	// ac.regPalettes[2] = 0;
	// ac.regPalettes[3] = 0;
	// ac.regPalettes[4] = 0;
	// ac.regPalettes[5] = 0x4;
	// ac.regPalettes[6] = 0;
	// ac.regPalettes[7] = 0;
	// ac.regPalettes[8] = 0;
	// ac.regPalettes[9] = 0x8;
	// ac.regPalettes[10] = 0;
	// ac.regPalettes[11] = 0;
	// ac.regPalettes[12] = 0;
	// ac.regPalettes[13] = 0xd6;
	// ac.regPalettes[14] = 0xd;
	// ac.regPalettes[15] = 0x10;
	// ac.regAttributeMode = 0;
	// ac.regOverscanColor = 0;
	// ac.regColorPlane = 0;
	// ac.regHorizPixel = 0;
	// ac.regPixelShift = 0;
	...
	get_seq(seq);
	seq.regReset = 0x0;
	seq.regClocking = 0x6f;
	seq.regMapMask = 0x0;
	seq.regCharMapSelect = 0;
	seq.regSeqMemoryMode = 0x0;
	// set_seq(seq);
